...
# Mode Objects
_MOD_OBJ = map_utils.o map_mode.o map_tiles.o map_objects.o map_sprites.o map_events.o map_zones.o
...
# Mode Headers
_MOD_DEP = map_utils.hpp map_mode.hpp map_tiles.hpp map_objects.hpp map_sprites.hpp map_events.hpp map_zones.hpp
