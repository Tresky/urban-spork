 ...
 ****************************/
// Script::Script(const std::string& _filename)
//   : filename(_filename)
// {
//   IF_PRINT_DEBUG(SCRIPT_DEBUG) << "Script constructor called" << endl;
//
//   state = new lua_newstate();
//   lua_openlibs(state);
//
//   // These return 0 on success, so the logic is backwards
//   if (luaL_loadFile(state, _filename.c_str()) || lua_pcall(state, 0, 0, 0))
...
// Script::~Script()
// {
//   IF_PRINT_DEBUG(SCRIPT_DEBUG) << "Script destructor called" << endl;
// }
//
// void Script::PrintError(const std::string& _var_name, const std::string& _reason)
// {
//     PRINT_ERROR << "Can't get [" << _var_name << "]. " << _reason << endl;
// }
//
// template<typename T>
// T Script::Get(const std::string& _var_name)
// {
//   if (!state)
//   {
//     PrintError(_var_name, "Script is not loaded");
//     return GetDefault<T>();
//   }
//
//   T result;
//   if (GetToStack(_var_name))
//     result = LuaGet<T>(_var_name);
//   else
//     result = GetDefault<T>();
//
//   lua_pop(state, level + 1);
//   return result;
// }
//
// bool Script::GetToStack(const string& _var_name)
// {
//   level = 0;
//   string var = "";
...
//       {
//         PrintError(_var_name, var + " is not defined");
//         return false;
//       }
//       else
//       {
